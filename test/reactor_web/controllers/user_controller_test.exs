defmodule ReactorWeb.UserControllerTest do
  use ReactorWeb.ConnCase

  import Reactor.AccountsFixtures

  @create_attrs %{email: "some email", is_verified: true, name: "some name", password_hash: "some password_hash", website: "some website"}
