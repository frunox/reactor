defmodule ReactorWeb.CommentControllerTest do
  use ReactorWeb.ConnCase

  import Reactor.ContentFixtures

  @create_attrs %{html: "some html", is_flagged: true, is_published: true, markdown: "some markdown"}
  ...
  describe "update comment" do
    ...
    test "redirects when data is valid", %{conn: conn, comment: comment} do
      ...
      assert html_response(conn, 200) =~ "some updated html"
    end
